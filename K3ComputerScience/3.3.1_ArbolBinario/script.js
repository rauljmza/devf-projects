...
class ArbolBinario{
    ...
    insertar(valor){
        if(this.raiz == null){
            ...
            //Valores mayores a la izquierda
    ...
    //Si se sale del while es porque no se encontró el valor
    buscar(valor){
        let nodoActual = this.raiz;
...
if(arbolBinario.buscar(valorABuscar)){
    console.log(`El valor ${valorABuscar} SÍ está el árbol`);
}else{
    console.log(`El valor ${valorABuscar} NO está el árbol`);
}
